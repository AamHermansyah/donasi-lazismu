      ...
      <div className="container mx-auto my-10">
        <div className="text-center space-y-4">
          <h1 className="text-secondary text-3xl sm:text-5xl xl:text-6xl font-bold">
           Program Kebaikan & Pemberdayaan
          </h1>
          <p className="text-center max-w-3xl mx-auto sm:text-base text-sm">
          Berikut adalah berbagai program pendayagunaan ZISKA (Zakat, Infak, Sedekah, dan Wakaf) yang dapat Anda dukung. Setiap program bertujuan untuk mewujudkan kesejahteraan masyarakat dan penanggulangan kemiskinan.
          </p>
        </div>
